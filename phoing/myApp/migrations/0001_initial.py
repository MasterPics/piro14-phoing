# Generated by Django 3.1.5 on 2021-02-08 08:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('photographer', 'photographer'), ('model', 'model'), ('HairMakeup', 'HairMakeup'), ('stylist', 'stylist'), ('other use', 'other use')], default='other use', max_length=20)),

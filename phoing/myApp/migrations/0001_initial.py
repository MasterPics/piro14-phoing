# Generated by Django 2.1.15 on 2021-02-02 12:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('photographer', 'photographer'), ('model', 'model'), ('H&M', 'H&M'), ('stylist', 'stylist'), ('other use', 'other use')], max_length=2)),
        ...
        migrations.AddField(
            model_name='post',
            name='save_users',
            field=models.ManyToManyField(related_name='save_users', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='post',
            name='user',
